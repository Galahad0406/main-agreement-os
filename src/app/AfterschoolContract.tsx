...
import { Check, Lock, Unlock, ArrowLeft } from "lucide-react"
...
export default function AfterschoolContract() {
  // Parent info
  ...
  return (
    ...
    >
      ...
      <div className="max-w-[680px] mx-auto px-4 pt-6">
        ...
        <Link
          to="/"
          className="inline-flex items-center gap-1.5 text-[13px] font-medium text-[#6E6E73] hover:text-[#0071E3] transition-colors mb-6"
        >
